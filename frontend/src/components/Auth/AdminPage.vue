...
// Computed properties
const feedback = computed(() => adminStore.feedback);
const userEmails = computed(() => adminStore.userEmails);
const error = computed(() => adminStore.error);
const totalEmails = computed(() => userEmails.value.length);

// Lifecycle hooks
onMounted(() => {
    adminStore.fetchFeedback();
    adminStore.fetchUserEmails();
});
</script>
